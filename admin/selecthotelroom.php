<?php
 ...
 $_SESSION['selecthotel5']= $_POST['hotel2'];
 if($_SESSION['selecthotel5'])
...
<body>
    <div class="container">
        ...
        ?>
            <form action="selecthotelroom.php" method="post">
            <div class="d-flex flex-row justify-content-center">
                ...
                <button type="submit" class="btn btn-danger register-button User-dropdown" onclick="window.location.href= 'addroom.php'">Proceed</button>
            </div>
            </div>
                    </form>
